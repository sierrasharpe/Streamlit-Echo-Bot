...
def ai_ask(prompt, data=None, temperature=0.5, max_tokens=250, model="mistral-small-latest", api_key=None, api_url="https://api.mistral.ai/v1/chat/completions"):
  if api_key is None or api_url is None:
    ...
    return "Login on the Functions tab for limited demo usage, or sign up for a free Mistral AI account"
    "at https://console.mistral.ai/ and add your own api_key."
...
def response_generator():
  ...
  "Please provide a response given the provided context. Please provide the"
  "response only with no before or after commentary.",
